      ...
      <div className="flex items-start gap-5">
        ...
        <div className="flex-1">
          ...
          <div className="flex justify-end">
            <Link 
              href={`/agents/${slug}`}
              className="bg-primary text-white px-4 py-2 rounded-lg text-sm font-medium shadow-md hover:bg-primary/90 transition-all duration-200 focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 dark:bg-white dark:text-dark dark:hover:bg-white/90 dark:focus:ring-primary/70 dark:focus:ring-offset-dark group inline-flex items-center"
            >
              View Dashboard
